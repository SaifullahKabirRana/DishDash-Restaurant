                                ...
                                <div key={menu._id}>
                                    <div className="">
                                        ...
                                        <div className="bg-[#F3F3F3] ">
                                            <div className="flex flex-col font-inter text-center py-4 md:py-5 xl:py-6 2xl:py-7 ">
                                                ...
                                                <div>
                                                    <Link>
                                                        <button className=" btn btn-sm md:btn-md border-t-0 border-l-0 border-r-0  bg-[#E8E8E8] text-[#BB8506] font-inter text-sm md:text-base lg:text-lg xl:tex-xl border-b-2 border-[#1F2937] rounded-xl uppercase  hover:bg-[#1F2937] hover:border-none ">add to cart</button>
                                                    </Link>
                                                </div>
                                            </div>
                                        </div>
