                            ...
                            <div
                                ...
                                <div className={`px-[30px] md:px-[120px] lg:px-[180px] xl:px-[250px] 2xl:px-[300px] ${paddingY}`}>
                                    <div className='flex justify-center items-center'>
                                        <div className='bg-[#15151599] min-w-full sm:min-w-[550px] md:min-w-[650px] lg:min-w-[820px] xl:min-w-[1020px] 2xl:min-w-[1320px] px-6 md:px-10 lg:px-12 xl:px-14 2xl:px-20 min-h-[160px] md:min-h-[250px] lg:min-h-[300px] xl:min-h-[350px] 2xl:min-h-[400px] text-center flex flex-col justify-center items-center '>
