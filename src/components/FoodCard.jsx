                                    ...
                                    <div className="">
                                        ...
                                        <div className="bg-[#F3F3F3] ">
                                            <div className="flex flex-col font-inter text-center py-5 md:py-6 xl:py-7 2xl:py-8 ">
                                                ...
                                                <div>
                                                    <Link>
                                                        <button className=" btn btn-sm md:btn-md border-t-0 border-l-0 border-r-0  bg-[#E8E8E8] text-[#BB8506] font-inter text-sm md:text-base  xl:tex-xl border-b-2 border-[#1F2937] rounded-xl uppercase  hover:bg-[#1F2937] hover:border-none focus:bg-[#1F2937] focus:border-none mt-1">add to cart</button>
                                                    </Link>
                                                </div>
                                            </div>
                                        </div>
