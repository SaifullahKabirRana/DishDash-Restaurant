    ...
    return (
       <div className='pt-6 md:pt-8 lg:pt-10 xl:pt-14 pb-8 md:pb-12 lg:pb-14 xl:pb-20'>
         <div className='w-full flex justify-center '>
            <div className='max-h-[300px] md:max-h-full max-w-[330px] sm:max-w-[550px] md:max-w-[650px] lg:max-w-[750px] xl:max-w-[1020px] 2xl:max-w-[1320px] font-cinzel uppercase text-white'>
                <Swiper
                    slidesPerView={1}
                    spaceBetween={10}
                    pagination={{
