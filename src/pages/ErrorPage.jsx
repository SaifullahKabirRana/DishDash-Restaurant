...
import error from '../assets/assets/404.gif'
        ...
        <div className=' py-16 md:py-20 xl:py-28 font-inter'>
            ...
            <div className='flex justify-center mt-6 md:mt-8 xl:mt-12 gap-6 md:gap-6 xl:gap-10'>
                <div onClick={handleGoBack}>
                    <h2 className='btn btn-sm shadow-xl border-none px-6 lg:px-8 font-bold text-sm xl:text-base bg-[#D1A054] text-black hover:opacity-70'>Go Back</h2>
                </div>
                <div>
